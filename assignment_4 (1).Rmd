...
treat <- datasummary(Factor(rev) * (growth+rgdp60)~( mean + median + sd + min + max ), data = GrowthSW)
...
The p-value test is the probability that a statistical measure, in this case the mean of the t distribution is greater or equal to the observed results.
