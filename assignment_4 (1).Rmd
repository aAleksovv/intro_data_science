...
# GrowthSW$rev <-ifelse(GrowthSW$revolutions > 0, "Revolutions", "No Revolutions")
# 
...
# group_0 <- GrowthSW[GrowthSW$rev == "No Revolutions", ]
# group_1 <- GrowthSW[GrowthSW$rev == "Revolutions", ]
